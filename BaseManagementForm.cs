...
namespace QLGD_WinForm
{
    public partial class BaseManagementForm : Form
    {
        ...
        public BaseManagementForm(string title, string configName, Size size) : this()
        {
            this.Text = title;
            this.Size = size;
        }
        ...
        #region Protected Methods for Toolbar
        protected void SetupToolbar(TextBox txtSearch, Button btnSearch, Button btnAdd,
            Button btnEdit, Button btnDel, string lblText)
        {
